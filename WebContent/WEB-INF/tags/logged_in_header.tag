...
<header>
    ...
    <form>
        ...
        <button formmethod="post" type="submit" formaction="all_active_auctions.jsp">All Active Auctions</button>

        |

        <button formmethod="post" type="submit" formaction="create_auction_form.jsp">Sell an Item in an Auction</button>

        <button formmethod="post" type="submit" formaction="add_alert_to_wishlist_form.jsp">Add an Alert to my
            Wishlist
        </button>
