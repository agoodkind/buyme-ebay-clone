...
<%--* TODO: will be able to create accounts for customer representatives.--%>
<%--* This person must also be able to generate summary sales reports,--%>
<%--* including:--%>
<%--* TODO: total earnings,--%>
<%--* TODO: earnings per { item, item type, end-user}, (use get_item_details.jsp)--%>
<%--* TODO: best- selling {items, end-users}.  --%>
<%--* TODO: Communications/notifications between BuyMe, end-users and/or customer representatives, which would normally be done via email,--%>
<%--* are to be simulated by inserting a row into a special table named EMAIL, with columns labelled from, to, subject, date_time, content. --%>
<%--*/--%>
<!DOCTYPE html>
<html>
<head>
